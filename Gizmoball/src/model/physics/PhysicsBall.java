...
public class PhysicsBall implements IPhysicsObject, Observer
{
	...
	public void reflect(IPhysicsObject object)
	{
		switch (object.getType())
		{
			...
			case RotatingCircle:
				RotatingCircle c = (RotatingCircle)object;
				velocity = Geometry.reflectRotatingCircle(c.getCircle(), c.getCentre(), c.getAngularVelocity(), circle, velocity, 0.85);
				break;
				
			case RotatingWall:
				RotatingWall w = (RotatingWall)object;
				velocity = Geometry.reflectRotatingWall(w.getLine(), w.getCentre(), w.getAngularVelocity(), circle, velocity, 0.85);
				break;
